...
The file name intentionally maps TeamSpeak plugin-command traffic to the existing Windows x64 TFAR namespace (`TFAR_win64`) so mixed Linux/Windows clients can exchange radio and voice state commands.
