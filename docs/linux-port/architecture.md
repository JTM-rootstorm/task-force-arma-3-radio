...
Build artifact: `TFAR_linux_amd64.so`
...
`TFAR_linux_amd64.so` is the canonical, live-proven Linux artifact. Alternate compatibility-derived filenames are unsupported.
